...
<div class = "oohbaby">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-01.png">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-02.png">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-03.png">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-04.png">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-05.png">
  <img class="quint_p myImages" id="myImg" src="/imgs/collaborative report-06.png">

</div>

<button class="prev" onclick="window.location.href = '/projects/gy1s1_charlottesvilleEVfleet.html';"> < Previous Project
